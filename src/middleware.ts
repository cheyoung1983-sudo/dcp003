...
export async function middleware(request: Request) {
  ...
  if (response instanceof NextResponse) {
    const csp = [
      ...
      "img-src 'self' data: blob: https://*.google.com https://*.google-analytics.com https://*.gstatic.com https://*.auth0.com https://*.githubusercontent.com https://picsum.photos https://*.picsum.photos",
